...
let PotentialLinkMonitorController = class PotentialLinkMonitorController {
    ...
    async getPotentialLinkMonitor(query, res) {
        ...
        try {
            const data = await this.productsService.getPotentialLinkMonitorData(shopID, shopName);
    ...
    async getPotentialLinkMonitorChart(query, res) {
        ...
        try {
            const data = await this.productsService.getPotentialLinkMonitorChartData(shopID, shopName, productID, startDate, endDate);
            return res.status(common_1.HttpStatus.OK).json({
                success: true,
                message: '查询成功',
                data,
    ...
    async savePotentialLinkMonitorAnalysis(body, res) {
        ...
        try {
            await this.productsService.savePotentialLinkMonitorAnalysis(shopID, shopName, productID, analysis, improvementPlan);
            return res.status(common_1.HttpStatus.OK).json({
                success: true,
                message: '保存成功',
            });
...
__decorate([
    ...
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [monitor_chart_dto_1.PotentialLinkMonitorChartDto, Object]),
    __metadata("design:returntype", Promise)
], PotentialLinkMonitorController.prototype, "getPotentialLinkMonitorChart", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PotentialLinkMonitorController.prototype, "savePotentialLinkMonitorAnalysis", null);
